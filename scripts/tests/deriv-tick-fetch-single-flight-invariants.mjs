...
console.log('[Deriv Tick Single-Flight Invariant] passed: concurrent live tick-history requests for the same symbol share one in-flight fetch and avoid duplicate Deriv WebSocket connections.');
