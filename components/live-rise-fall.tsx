...
export function LiveRiseFall({
  ...
  return (
    <RiseFallView
      ...
      onReorder={onReorder}
      isAutoDuration={trading.isAutoDuration}
      setIsAutoDuration={trading.setIsAutoDuration}
      autoHorizonMode={trading.autoHorizonMode}
      setAutoHorizonMode={trading.setAutoHorizonMode}
      realtimeSignals={trading.realtimeSignals}
    />
  );
}
